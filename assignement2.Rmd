...
# KNN Algorithm
## Normalization
We'll normalized our data to make sure our classifier will work using a simple normalization function (min/max normalization):
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
...
We used the normalization function on our data, and made sure it worked:
```{r, message=FALSE, warning=FALSE}
