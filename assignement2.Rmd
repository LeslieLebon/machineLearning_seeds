...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
error_cost <- matrix(c(0, 1,1,1,0,1,1,1, 0), nrow = 3, dimnames = matrix_dimensions)
...
CrossTable(seeds_test$Type, seeds_cost_pred, prop.chisq = FALSE, prop.c = FALSE, prop.r = FALSE)
```
### DT conclusions
